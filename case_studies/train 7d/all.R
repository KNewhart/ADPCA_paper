...
save("results.all", file="case_studies/train 7d/results.RData")
...
printToPowerPoint(code.block = {
  data2print
}, presentation.path="case_studies/train 7d/", type="table", title="Jan 2018 - 7 days")
printToPowerPoint(code.block = {
  c(
...
}, presentation.path="case_studies/train 7d/", type="text", title="Jan 2018 - 7 days")
