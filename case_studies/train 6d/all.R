...
# graph_rawData(rawData, paste0("case_studies/train 6d/",keyword))
...
save("results.all", file="case_studies/train 6d/results.RData")
...
printToPowerPoint(code.block = {
  data2print
}, type="table", title="Jan 2018 - 6 days")
