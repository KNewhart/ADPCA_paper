...
save("results.all", file="case_studies/train 5d/results.RData")
...
printToPowerPoint(code.block = {
  data2print
}, presentation.path="case_studies/train 5d/", type="table", title="Jan 2018 - 5 days")
printToPowerPoint(code.block = {
  c(
...
}, presentation.path="case_studies/train 5d/", type="text", title="Jan 2018 - 5 days")
