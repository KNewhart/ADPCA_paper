...
rm(list=ls())
library(ADPCA)
case_study_data_compiler <- function(keyword, testingDay = as.Date("2018 01 01", format = "%Y %m %d"), days, rollingWindowDays, testMT = TRUE, alphaN = 0.01) {
...
case_study_data_compiler(keyword = "Aug 2018", testingDay = as.Date("2018 08 15", format = "%Y %m %d"), days = 17, rollingWindowDays = 3, testMT = FALSE)
```

```{r Aug 2018 5 day, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE, paged.print=FALSE}
case_study_data_compiler(keyword = "Aug 2018", testingDay = as.Date("2018 08 15", format = "%Y %m %d"), days = 17, rollingWindowDays = 5, testMT = FALSE)
```

```{r Aug 2018 7 day, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE, paged.print=FALSE}
case_study_data_compiler(keyword = "Aug 2018", testingDay = as.Date("2018 08 15", format = "%Y %m %d"), days = 17, rollingWindowDays = 7, testMT = FALSE)
```

```{r Aug 2018 10 day, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE, paged.print=FALSE}
...
```{r Jan 2018 3 day, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE, paged.print=FALSE}
case_study_data_compiler(keyword = "Jan 2018", testingDay = as.Date("2018 01 01", format = "%Y %m %d"), days = 31, rollingWindowDays = 3)
```

```{r Jan 2018 5 day, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE, paged.print=FALSE}
case_study_data_compiler(keyword = "Jan 2018", testingDay = as.Date("2018 01 01", format = "%Y %m %d"), days = 31, rollingWindowDays = 5)
# case_study_data_compiler(keyword = "Jan", testingDay = as.Date("2018 01 01", format = "%Y %m %d"), days = 31, rollingWindowDays = 5, testMT = FALSE)
```

```{r Jan 2018 7 day, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE, paged.print=FALSE}
case_study_data_compiler(keyword = "Jan 2018", testingDay = as.Date("2018 01 01", format = "%Y %m %d"), days = 31, rollingWindowDays = 7)
```

```{r Jan 2018 10 day, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE, paged.print=FALSE}
case_study_data_compiler(keyword = "Jan 2018", testingDay = as.Date("2018 01 01", format = "%Y %m %d"), days = 31, rollingWindowDays = 10)
```

```{r Feb 2018 3 day, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE, paged.print=FALSE}
case_study_data_compiler(keyword = "Feb 2018", testingDay = as.Date("2018 02 01", format = "%Y %m %d"), days = 28, rollingWindowDays = 3)
```
...
case_study_data_compiler(keyword = "Mar 2018", testingDay = as.Date("2018 03 01", format = "%Y %m %d"), days = 31, rollingWindowDays = 7)
```
