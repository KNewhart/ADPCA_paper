...
### Declare parameters & run ADPCA 
```{r message=FALSE, warning=FALSE, paged.print=FALSE}
# January
keyword <- "continuous"
## ADPCA parameters ##
# Date to be evaluated with ADPCA model
testingDay <- as.Date("2018 09 19", format = "%Y %m %d")
# Number of days to train on
rollingWindowDays <- 10
# Number of times model is updated 
updateDays <- 6
...
# save(just.alarms, file = "alarms 2018-01-01 2018-05-15 10d.Rdata")
# load(file = "alarms 2018-01-01 2018-05-15 10d.Rdata")
```
